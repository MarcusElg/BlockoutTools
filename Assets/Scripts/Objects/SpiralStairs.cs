...
public class SpiralStairs : MonoBehaviour
{
    ...
    private void GenerateMesh()
    {
        ...
        if (type == Type.Straight)
        {
            ...
            AddStraightStairSide(ref vertices, ref triangles, ref uvs, segments, actualDepth, Vector3.left, 0); // Left side
            AddStraightStairSide(ref vertices, ref triangles, ref uvs, segments, actualDepth, Vector3.right, segments * 3 + 1); // Right side
        }
        else
        {
            int segments = (int)(Vector3Extensions.XZDistance(Vector3.zero, targetPosition) / depth);
    ...
    private void AddStraightStairSide(ref List<Vector3> vertices, ref List<int> triangles, ref List<Vector2> uvs, int segments, float actualDepth, Vector3 left, int offset)
    {
        // Top part
    ...
    private void AddSpiralStairSide(ref List<Vector3> vertices, ref List<int> triangles, ref List<Vector2> uvs, int segments, float actualDepth, int offset)
    {
